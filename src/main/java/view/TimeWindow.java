...
public class TimeWindow {
    public static void displayTimeWindow(){
        ...
        Tab tab1 = new Tab("Duration between dates", new Label("Gives the duration between two dates.\n" +
                "Accepted formats are : YYYY"));
        Tab tab2 = new Tab("Adding seconds to date"  , new Label("Input : a date and a number of seconds.\n" +
                "Outputs the date corresponding to the original date plus/minus the number of asked seconds."));
