...
//		log.saveLog();
			log.loadLog();
			log.display();
			List <Expression> params14 = new ArrayList<>();
			Collections.addAll(params14, new MyNumber(new BigDecimal(8,precision), 5, new BigDecimal(9,precision), 6), new MyNumber(new BigDecimal(10,precision)));
			//Collections.addAll(params14, new MyNumber(new BigDecimal(8,precision),  new BigDecimal(9,precision)), new MyNumber(new BigDecimal(10,precision)));
			e = new Times(params14, Notation.INFIX);
			...
			memory.loadMemory();
			memory.display();
			List <Expression> params15 = new ArrayList<>();
			Collections.addAll(params15, new MyNumber(new BigDecimal(8,precision), 5, new BigDecimal(9,precision), 6), new MyNumber(new BigDecimal(10,precision)));
			//Collections.addAll(params14, new MyNumber(new BigDecimal(8,precision),  new BigDecimal(9,precision)), new MyNumber(new BigDecimal(10,precision)));
			e = new Times(params14, Notation.INFIX);
			System.out.println(c.eval(e));
			memory.add("test",c.eval(e), e);
			memory.saveMemory();
